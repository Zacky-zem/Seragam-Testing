    ...
    <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
      <section className="overflow-hidden rounded-[2rem] bg-primary text-primary-foreground shadow-xl">
        <div className="grid gap-8 p-6 sm:p-10 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div className="flex flex-col gap-5">
            <div className="flex items-center gap-2 text-sm font-semibold text-accent"><Sparkles data-icon="inline-start" /> Sistem Pengelolaan Seragam</div>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          ...
          <ChartCard title="Ukuran Celana Kerja" description="Ukuran celana 27–42" src={TROUSER_CHART} />
        </div>
      </section>
