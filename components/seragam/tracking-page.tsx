      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button type="button" onClick={onRequireAuth} className="inline-flex items-center gap-1.5 rounded-xl border border-amber-300 bg-white px-3.5 py-2 text-xs font-semibold text-amber-900 shadow-sm transition-colors hover:bg-amber-50">
              <Upload className="h-3.5 w-3.5 text-amber-600" />
              <span>Upload</span>
            </button>
            <input ref={receiptUploadInputRef} type="file" accept=".xlsx,.xls,.csv" onChange={importPenerimaan} className="hidden" />
            <button type="button" onClick={onRequireAuth} className="inline-flex items-center gap-1.5 rounded-xl border border-emerald-300 bg-white px-3.5 py-2 text-xs font-semibold text-emerald-900 shadow-sm transition-colors hover:bg-emerald-50">
              <PackageCheck className="h-3.5 w-3.5 text-emerald-600" />
              <span>Update Penerimaan</span>
            </button>
            <button onClick={onRequireAuth} className="inline-flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-semibold text-slate-700 shadow-sm transition-colors hover:bg-slate-50">
